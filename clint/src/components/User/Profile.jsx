...
const Profile = () => {
  ...
  const CompactItem = ({ icon: Icon, label, sublabel, onClick, variant = "default" }) => (
    ...
    >
      <div className={`w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 ${variant === "danger" ? "bg-red-50 text-red-500" : "bg-emerald-50 text-emerald-600"
        }`}>
        <Icon size={18} />
      </div>
  ...
  const ActionCard = ({ icon: Icon, label, sublabel, onClick, variant = "default", color = "emerald" }) => (
    ...
    >
      <div className={`w-12 h-12 rounded-2xl flex items-center justify-center flex-shrink-0 transition-colors ${variant === "danger" ? "bg-red-50 text-red-500" : `bg-${color}-50 text-${color}-600 group-hover:bg-${color}-600 group-hover:text-white`
        }`}>
        <Icon size={24} />
      </div>
      ...
      <div className="md:hidden pb-28 pt-8">
        ...
        <div className="px-5 mt-5 space-y-4">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mt-2">
            ...
            <CompactItem icon={Trash2} label="Delete Account" variant="danger" onClick={() => navigate('/delete-account')} />
          </div>
          ...
          <div className="grid grid-cols-12 gap-8 items-start">
            ...
            <div className="col-span-7 space-y-8">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <ActionCard icon={Trash2} label="Delete Account" sublabel="Permanent action" onClick={() => navigate('/delete-account')} variant="danger" />
              </div>
