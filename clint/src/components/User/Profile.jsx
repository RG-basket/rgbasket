                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      >
                        ...
                        <p className="text-green-900 font-medium">{user.active ? 'Active' : 'Inactive'}</p>
                      </motion.div>
                      <motion.div 
                  ...
                  >
                    ...
                    <div className="bg-gray-50 border border-gray-200 rounded-xl p-6">
                      ...
                      <p className="text-gray-900">
                        {user.address || (
                          <span className="text-gray-400 italic">No address provided. Add your delivery address for faster checkout.</span>
                        )}
                      </p>
                    </div>
                  </motion.div>
