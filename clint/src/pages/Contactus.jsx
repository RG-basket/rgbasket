...
const ContactUs = () => {
  ...
  const handleWhatsApp = () => {
    ...
    window.open(`https://wa.me/91${whatsappNumber}?text=${encodeURIComponent(message)}`);
  };
      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          >
            ...
            <div className="text-green-600 font-semibold text-lg">+91 {whatsappNumber}</div>
            <motion.button
          ...
          >
            ...
            <h3 className="text-2xl font-bold text-gray-900 mb-2">Phone Call</h3>
            <p className="text-gray-600 mb-4 text-sm">Speak directly with our team</p>

            <div className="space-y-3">
              <div className="flex flex-col gap-2">
                <div className="text-blue-600 font-bold text-base">+91 {phoneNumber}</div>
                <motion.button
                  ...
                  className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors flex items-center justify-center gap-2"
                >
              ...
              <div className="flex flex-col gap-2">
                <div className="text-blue-500 font-bold text-base">+91 {partnerNumber}</div>
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  onClick={(e) => {
                    e.stopPropagation();
                    handleCall(partnerNumber);
                  }}
                  className="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-lg text-sm font-semibold transition-colors flex items-center justify-center gap-2"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">7:00 AM – 10:00 PM Daily</p>
            </div>
          </div>
        </motion.div>
