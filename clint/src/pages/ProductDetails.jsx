            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              {product.isSpecialRequest ? (
                <button
                  ...
                  className="flex-1 w-full h-14 rounded-xl font-bold text-lg flex items-center justify-center gap-3 transition-all bg-[#25D366] text-white hover:bg-[#128C7E] shadow-lg hover:shadow-green-200"
                >
