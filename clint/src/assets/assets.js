...
export const dummyProducts = [
  {
    ...
    category: "Offline",
    weights: [
      { weight: "Check Connection", price: 0, offerPrice: 0 },
      { weight: "Refresh Page", price: 0, offerPrice: 0 },
      { weight: "Try Again", price: 0, offerPrice: 0 }
    ],
    image: [],
    description: [
      "Please check your internet connection",
      "Unable to load products from server",
      "Products will appear when online"
    ],
